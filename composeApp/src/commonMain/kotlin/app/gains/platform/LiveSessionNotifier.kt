 ...
 */
internal data class LiveSessionNotice(val title: String, val startedAtMs: Long, val restEndsAtMs: Long? = null)

/** Shown and cleared by the shared UI as the running workout comes and goes. Always called on the main thread. */
internal fun interface LiveSessionNotifier {
 ...
 */
internal abstract class NoticeRequests {
 ...
 */
internal object ResumeRequests : NoticeRequests()
 ...
 */
internal object SkipRestRequests : NoticeRequests()
